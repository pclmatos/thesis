...
In general, in distributed systems, \textbf{faults} can be defined as the deviation of a component from it's correct behavior. In order to develop a reliable system, it is important to make assumptions about how a process might fail. Therefore, it is of extreme importance to define a fault model. Table~\ref{tab:fault_models} presents some of the most commom fault models considered in existing systems.

\begin{table}[H]
\rowcolors{1}{}{GhostWhite}
\begin{xltabular}{\textwidth}{cX}
  \caption{Fault models based on~\cite{fault-tolerance-distributed-systems}.}
