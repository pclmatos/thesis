...
\nttitle(main,en){Fault-tolerance in a Publish/Subscribe system with multiple delivery guarantees}%
\nttitle(main,pt){Tolerância a falhas em sistema Publicador/Subscritor com múltiplas garantias de entrega}%
...
\ntdepartment*(en){Department of\\Department Name}
...
%-------------------------------------------------------------------
\ntauthorname(m){Paulo César Leite de Matos}{Paulo Matos}
...
%         You may use "\\" to force line breaks
% Advisers(s)
\ntaddperson{adviser}(a,f){Hervé Miguel Cordeiro Paulino, Associate Professor, NOVA School of Science and Technology}
% Co-advisers(s)
